/**
* Digital Sindh - LMS, Education and Course Theme
*
...
const links = document.querySelectorAll('#sidebar-account, .nav a, .list-group-item');

links.forEach(item => {
    const currentPageUrl = window.location.pathname;

    if (currentPageUrl === item.pathname) {
