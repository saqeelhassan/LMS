...
<head>
    ...
    {{-- Super Admin UI assets (index-3) --}}
    <link rel="stylesheet" href="{{ asset('Dsimt-lms-assets/vendor/jqvmap/css/jqvmap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Dsimt-lms-assets/vendor/chartist/css/chartist.min.css') }}">
...
<body>
    ...
    <div id="main-wrapper">
        @include('layouts.partials.super-admin-dsimt-nav-header')
        @include('layouts.partials.super-admin-dsimt-header')
        @if(auth()->check() && auth()->user()->role?->name === 'Instructor')
            @include('layouts.partials.instructor-dsimt-sidebar')
        @else
            @include('layouts.partials.super-admin-dsimt-sidebar')
        @endif
    ...
    <script src="{{ asset('Dsimt-lms-assets/vendor/chart.js/Chart.bundle.min.js') }}"></script>
    <script src="{{ asset('Dsimt-lms-assets/vendor/peity/jquery.peity.min.js') }}"></script>
    <script src="{{ asset('Dsimt-lms-assets/vendor/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
