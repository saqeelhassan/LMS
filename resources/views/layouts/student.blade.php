...
<head>
    ...
    {{-- Same UI assets as super-admin (Dsimt-lms-assets) --}}
...
<body>
    ...
    <div id="main-wrapper">
        @include('layouts.partials.student-dsimt-nav-header')
        @include('layouts.partials.student-dsimt-header')
        @include('layouts.partials.student-dsimt-sidebar')
