...
<head>
    ...
    {{-- Same UI assets as dashboard (Dsimt-lms-assets) --}}
...
<body>
    ...
    <div id="main-wrapper">
        @include('layouts.partials.guest-dsimt-nav-header')
        @include('layouts.partials.guest-dsimt-header')
        @include('layouts.partials.guest-dsimt-sidebar')
