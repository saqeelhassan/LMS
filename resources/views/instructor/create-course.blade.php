                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="bg-body border rounded-bottom h-400px overflow-hidden"
                                                ...
                                                <br>
                                                <p>Quill is a free, open-source WYSIWYG editor built for the modern web.
                                                    With its modular architecture and expressive API, it is completely
                                                    customizable to fit any need.</p>
                                                <br>
                                                <p>Insipidity the sufficient discretion imprudence resolution sir him
                                                    ...
                                                    of beauty tastes. </p>
                                                <br>
                                                <p> Affronting imprudence do he he everything. Test lasted dinner wanted
                                        ...
                                        <div class="col-12">
                                            <div class="bg-light border rounded p-4">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <span class="small">Maximum of 14 keywords. Keywords should all be
                                                        in lowercase. e.g. javascript, react, marketing</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Tags START -->
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="form-check mb-0 mt-2">
                                                        ...
                                                        <label class="form-check-label" for="exampleCheck1">
                                                            Any images, sounds, or other that are not my own work, have
                                                            been appropriately licensed for use in the file preview or
                                                            main course. Other than these items, this work is entirely
                                                            my own and I have full rights to sell it here.
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
