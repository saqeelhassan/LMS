                ...
                <div class="col-md-8">
                    <div class="row g-3 align-items-center justify-content-md-end me-auto">
                        ...
                        <div class="col-sm-4 col-xl-6 text-md-end d-none d-md-block">
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item"><a
                                        href="{{ route('courses.index') }}"
                                        class="btn btn-outline-light mb-0 me-2"><i
                                            class="fas fa-fw fa-list-ul"></i></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="col-4 text-md-end">
                            <button class="btn btn-primary mb-0 d-xl-none" type="button" data-bs-toggle="offcanvas"
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card shadow overflow-hidden p-2">
                                <div class="row g-0">
                                    <div class="col-md-5 overflow-hidden">
                                        <img src="/images/courses/4by3/06.jpg" class="rounded-2" alt="Card image">
                                        <!-- Ribbon -->
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <!-- Badge -->
                                                <a href="#"
                                                    class="badge text-bg-primary mb-2 mb-sm-0">Development</a>
                                                <!-- Rating and wishlist -->
                                                <div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <!-- Badge -->
                                                <a href="#"
                                                    class="badge text-bg-primary mb-2 mb-sm-0">Marketing</a>
                                                <!-- Rating and wishlist -->
                                                <div>
                                                    <span class="h6 fw-light me-3"><i
                                                            class="fas fa-star text-warning me-1"></i>4.5</span>
                        ...
                        <div class="col-12">
                            <div class="card shadow p-2">
                                <div class="row g-0">
                                    <div class="col-md-5">
                                        <img src="/images/courses/4by3/11.jpg" class="rounded-2" alt="Card image">
                                    </div>
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            <!-- Badge and rating -->
                        ...
                        <div class="col-12">
                            <div class="card shadow p-2">
                                <div class="row g-0">
                                    <div class="col-md-5">
                                        <img src="/images/courses/4by3/03.jpg" class="rounded-2" alt="Card image">
                                    </div>
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            <!-- Badge and rating -->
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <!-- Badge -->
                                                <a href="#"
                                                    class="badge text-bg-primary mb-2 mb-sm-0">Design</a>
                                                <!-- Rating and wishlist -->
                                                <div>
                                                    <span class="h6 fw-light me-3"><i
