                        ...
                        <div class="col-12 position-relative">
                            <div class="video-player rounded-3">
                                <video controls crossorigin="anonymous" playsinline poster="/images/videos/poster.jpg">
                                    <source src="/images/videos/360p.mp4" type="video/mp4" size="360">
                                    <source src="/images/videos/720p.mp4" type="video/mp4" size="720">
                                    <source src="/images/videos/1080p.mp4" type="video/mp4" size="1080">
                                    <!-- Caption files -->
                                    <track kind="captions" label="English" srclang="en" src="/images/videos/en.vtt"
                                        default>
                                ...
                                <div class="card card-body border p-4">
                                    ...
                                    <div class="d-sm-flex align-items-center">
                                        ...
                                        <div class="ms-sm-3 mt-2 mt-sm-0">
                                            ...
                                            <p class="mb-0 small">Founder Digital Sindh</p>
                                        </div>
                                    </div>
