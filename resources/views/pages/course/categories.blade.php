                ...
                <div class="col-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 col-md-3 text-center order-1">
                            <img src="/images/element/category-1.svg" alt="">
                        </div>
                        ...
                        <div class="col-6 col-md-3 text-center order-3">
                            <img src="/images/element/category-2.svg" alt="">
                        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div
                        ...
                        <!-- Image -->
                        <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                            <img src="/images/element/photography.svg" alt="">
                        </div>
                        <!-- Title -->
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div
                        ...
                        <!-- Image -->
                        <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                            <img src="/images/element/music.svg" alt="">
                        </div>
                        <!-- Title -->
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div
                        ...
                        <!-- Image -->
                        <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                            <img src="/images/element/marketing.svg" alt="">
                        </div>
                        <!-- Title -->
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div
                        ...
                        <!-- Image -->
                        <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                            <img src="/images/element/account.svg" alt="">
                        </div>
                        <!-- Title -->
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        ...
                        <img src="/images/flags/fr.svg" class="me-3 h-40px" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                        <img src="/images/flags/gr.svg" class="me-3 h-40px" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                        <img src="/images/flags/sp.svg" class="me-3 h-40px" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                        <img src="/images/flags/uk.svg" class="me-3 h-40px" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                        <img src="/images/flags/in.svg" class="me-3 h-40px" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                        <img src="/images/flags/it.svg" class="me-3 h-40px" alt="">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                        <img src="/images/flags/ar.svg" class="me-3 h-40px" alt="">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6 position-relative overflow-hidden">
                    <div class="bg-primary bg-opacity-10 rounded-3 p-5 h-100">
                        ...
                        <div class="position-absolute bottom-0 end-0 me-3">
                            <img src="/images/element/08.svg" class="h-100px h-sm-200px" alt="">
                        </div>
                        <!-- Content -->
                        <div class="row">
                ...
                <div class="col-lg-6 position-relative overflow-hidden">
                    <div class="bg-secondary rounded-3 bg-opacity-10 p-5 h-100">
                        <!-- Image -->
                        <div class="position-absolute bottom-0 end-0 me-3">
                            <img src="/images/element/15.svg" class="h-100px h-sm-200px" alt="">
                        </div>
                        <!-- Content -->
                        <div class="row">
                            <div class="col-sm-8 position-relative">
