...
<head>
    ...
    <title>Sign up as Staff - {{ config('app.name') }}</title>
        ...
        <div class="iofrm-layout">
            <div class="img-holder">
                ...
                <div class="info-holder">
                    <h3>Create your staff account.</h3>
                    <p>Register as staff to access the LMS platform.</p>
                ...
                <div class="form-content auth-signup">
                    <div class="form-items">
                        ...
                        <div class="page-links">
                            ...
                            <a href="{{ route('auth.sign-up.staff') }}" class="active">Register</a>
                        </div>
                        ...
                        <form method="post" action="{{ route('auth.register.staff') }}" enctype="multipart/form-data" class="auth-signup-form">
                            @csrf
                            <div class="row g-2">
                                <div class="col-md-6">
                            ...
                            <div class="form-button mt-3">
                                <button type="submit" class="ibtn btn btn-primary">Sign up as Staff</button>
                            </div>
                        </form>
                        ...
                        <div class="other-links mt-2">
                            ...
                            &nbsp;·&nbsp;
                            <a href="{{ route('auth.sign-up.student') }}">Sign up as Student</a>
                        </div>
                    </div>
                </div>
            </div>
